...
// Simple dialog to simulate extended bolus configuration
ExtendedBolusDialog::ExtendedBolusDialog(QWidget* parent)
    : QDialog(parent) {
...
double ExtendedBolusDialog::getDuration() const { return durationEdit->text().toDouble(); }
double ExtendedBolusDialog::getImmediatePercentage() const { return immediateEdit->text().toDouble(); }
double ExtendedBolusDialog::getExtendedPercentage() const { return extendedEdit->text().toDouble(); }
